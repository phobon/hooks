...
export const useOnKeyPress = (
  ...
  const handleKeyDown = useCallback((e: KeyboardEvent) => eventHandler(e, onKeyDownHandler, targetKey, targetModifier, debug), []);
  const handleKeyUp = useCallback((e: KeyboardEvent) => eventHandler(e, onKeyUpHandler, targetKey, targetModifier, debug), []);
